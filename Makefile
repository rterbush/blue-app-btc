...
# Zencash
DEFINES   += BTCHIP_P2PKH_VERSION=8329 BTCHIP_P2SH_VERSION=8342 BTCHIP_COIN_FAMILY=1 BTCHIP_COINID=\"Zencash\" COINID_UPCASE=\"ZENCASH\" COLOR_HDR=0xFF4300 COLOR_DB=0xFF8356 COINID_NAME=\"Zencash\" COINID=$(COIN) BTCHIP_COINID_SHORT=\"ZEN\" COIN_ZENCASH
APPNAME ="Zencash"
else
