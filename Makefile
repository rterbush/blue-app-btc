...
# Zencash
DEFINES   += BTCHIP_P2PKH_VERSION=7352 BTCHIP_P2SH_VERSION=7357 BTCHIP_COIN_FAMILY=1 BTCHIP_COINID=\"Zencash\" COINID_UPCASE=\"ZENCASH\" COLOR_HDR=0xFF4300 COLOR_DB=0xFF8356 COINID_NAME=\"Zencash\" COINID=$(COIN) BTCHIP_COINID_SHORT=\"ZEN\" COIN_ZENCASH
APPNAME ="Zencash"
else
